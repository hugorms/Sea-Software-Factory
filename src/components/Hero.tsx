    ...
    >
      ...
      >
        ...
        <div className="flex flex-col lg:grid lg:grid-cols-[42%_58%] gap-2 sm:gap-3 md:gap-3 lg:gap-10 items-center">
          ...
          <motion.p
            className="text-xs sm:text-sm md:text-base lg:text-lg xl:text-lg text-gray-600 leading-relaxed max-w-lg mx-auto text-center w-full order-2 lg:order-2 lg:col-start-1 lg:row-start-2"
            variants={titleVariants}
            initial="hidden"
            animate={isInView ? "visible" : "hidden"}
          >
